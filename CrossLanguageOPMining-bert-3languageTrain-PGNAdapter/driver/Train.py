...
if __name__ == '__main__':
    ...
    vocab = creat_vocab(config.source1_train_file, config.source2_train_file, config.target_train_file, config.min_occur_count)
    ...
    source1_data = read_corpus(config.source1_train_file, bert_token, lang_dic)
    source2_data = read_corpus(config.source2_train_file, bert_token, lang_dic)
